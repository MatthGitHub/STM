	...
	<div class="container">
      ...
      <!-- Main component for a primary marketing message or call to action -->
            ...
            <div class="row">
                ...
                <h4 class="text-center bg-info">Personas - Alta profesión</h4>
                </div>
                <div class="col-lg-6">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><form action="frm_alta_profesional.php" method="POST">
                                        ...
                                        <input type="submit" name="guardar" value="Seleccionar" class="btn btn-table">
                                        </form></td>
