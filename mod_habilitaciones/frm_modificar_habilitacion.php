...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	//Lleno los campos
	 ...
	 while ($row = mysqli_fetch_assoc($habilitacion_profesion)) 
	 {
 		...
 		$estado =  $row['estado'];
	 	$fecha_desde = fecha_mysql_normal($row['fecha_desde']);
	 	$fecha_hasta = fecha_mysql_normal($row['fecha_hasta']);
...
if(isset($_POST['guardar_habilitacion'])){
	...
	$output = '' ;
	$id_habilitacion = $_POST['txt_id_habilitacion'];
	...
	$sql = "UPDATE `tup_habilitaciones` 
	SET `nro_habilitacion`='$nro_habilitacion',
						...
						<div class="row">
							<div class="panel panel-default">
								<div class="panel-body">
									...
									<h4 class="text-center"><img src="../images/mod_habilitacion.png" alt="Municipalidad Bariloche" align="center" style="margin:0px 0px 0px 0px" height="64" width="64"></h4>
									...
									<div class="panel panel-default">
										<div class="panel-body">
											...
											<h3 class="text-center bg-info">Modificar Habilitación</h3>
												...
												<div class="form-group">
													<div class="input-group">
														...
														<input type="hidden" name="txt_id_profesion" value="<?php echo $profesion; ?>">
												     	...
												     	<input type="hidden" name="txt_id_habilitacion" value="<?php echo $id_habilitacion; ?>">
													</div>
												</div>
									...
									<div class="col-md-6 col-md-offset">
										<div class="panel panel-default">
											<div class="panel-body">							                       
						                        ...
						                        <div class="form-group">
													<div class="input-group">
														<span class="input-group-addon"><i class="fa fa-book fa-fw"></i> Entregada <input type="checkbox" name="entregada" value="1"  <?php if($entregada == true) echo "checked='checked'"; ?>/> </span>
													</div>
												</div>
