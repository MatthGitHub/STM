...
if (isset($_POST['guardar'])) {
	...
	$query = "INSERT INTO tipo_pago (nombre_tipo_pago) VALUES ('$nombre')";
    ...
    auditar($_SESSION['id'],$query);
		...
		echo "<h3>Error al cargar el tipo de pago!</h3>";
	}
...
<body>
	...
	<div class="container">
      ...
      <!-- Main component for a primary marketing message or call to action -->
        ...
        <h4 class="text-center"><img src="../images/tipo_pago.png" alt="Municipalidad Bariloche" align="center" style="margin:0px 0px 0px 0px" height="64" width="64"></h4>
					<h4 class="text-center bg-info">Cargar tipos de pago</h4>
						<div class="row">
							<div class="col-md-9 col-md-offset">
								<div class="form-group">
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-keyboard-o fa-fw"></i> Nombre tipo</span>
							...
							<div id="employee_table"></div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $row['nombre_tipo_pago']; ?></td>

                                        <td><input type="button" name="edit" value="Editar" id="<?php echo $row["id_tipo_pago"]; ?>" class="btn btn-info btn-xs edit_data" /></td>
           ...
           <div class="modal-content">
                ...
                <div class="modal-body">
                     <form method="post" id="insert_form">
                          <label>Editar tipo de pago</label>
      ...
      $(document).on('click', '.edit_data', function(){
           ...
           $.ajax({
                ...
                success:function(data){
                     $('#txt_nombre_actualizar').val(data.nombre_tipo_pago);
                     $('#employee_id').val(data.id_tipo_pago);
