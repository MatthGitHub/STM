    ...
    <div class="container">
        <br>
         ...
         <div class="row">
                <div class="col-lg-3">
                <br>
                <h4 class="text-center"><img src="../images/studying.png" alt="Municipalidad Bariloche" align="center" style="margin:0px 0px 0px 0px" height="64" width="64"></h4>

                    <h4 class="text-center bg-info">Turno Exámen</h4>
                </div>
                <div class="col-lg-6">
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><form action="frm_turno_examen.php" method="POST">
                                    ...
                                    <input type="submit" name="guardar" value="Registrar Turno" class="btn btn-table">
                                    </form></td>
